...
export default function HomePage() {
  ...
  useEffect(() => {
    const tempMentorData =
      MENTORS_DATA?.find((item) => item?.uri === window.location.pathname) ||
      null;
  ...
  const renderServiceCard = (item: any) => {
    return (
      <div
        key={item?.id}
        onClick={() => {
          window.open(mentorData?.calenderUrl, '_blank');
        }}
        className='group rounded-[32px] bg-[hsla(0,0%,100%,.95)] mb-5 relative cursor-pointer grid items-start text-dark hover:shadow-[12px_12px_32px_0_rgba(0, 0, 0, .1)]'
        style={{ transition: 'all .25s linear' }}
      >
          ...
          <div className='flex gap-3 items-center flex-wrap'>
            ...
            {item?.tags?.map((tag, index) => {
              return (
                <div
                  key={index}
                  className='rounded-[24px] font-bold text-sm  h-8 px-2 inline-flex items-center justify-center border bg-[#f3f3f7] ml-4'
                >
                  {tag}
                </div>
              );
        ...
        <div className='pt-4 flex flex-col items-stretch gap-2'>
          ...
          <div className='text-md px-6 py-0 font-light text-[#5c5c5c]'>
            {item?.description}
          </div>
        </div>
        <div className='pt-4 flex flex-col items-stretch gap-2'>
          <div className='flex rounded-[24px] m-4 py-3 px-4 relative overflow-hidden justify-between items-center bg-[#efeff0] group-hover:bg-[#e2e2e4]'>
            <div className='flex gap-2 items-center'>
              <NextImage
                alt='HAmburger'
                src={item?.card?.iconUrl}
                width={32}
                height={32}
              />
              <div className='flex flex-col items-start '>
                <div className='flex flex-col item-stretch'>
                  <div className='text-sm font-bold'>{item?.card?.title}</div>
                  <div
            ...
            <div className='flex flex-col justify-start items-center'>
              <div className='flex justify-center items-center bg-tranparent group-hover:bg-dark px-3 py-0 text-md font-semibold h-10 border border-[#141414] rounded-[24px]'>
                <div className='flex justify-center items-center gap-1'>
                  {item?.card?.price?.actual !== 0 && (
                    <div className=' text-xs font-medium text-grey-600 line-through group-hover:text-white'>
      ...
      <div className='rounded-[32px] bg-[hsla(0,0%,100%,.95)] mb-5 p-5 relative cursor-pointer grid items-start text-dark'>
        ...
        <div className='mt-8 flex justify-between'>
          <div className=''>
            ...
            <div className='text-xs font-normal text-[#797979]'>
              {item?.reviewDate}
            </div>
          </div>
        </div>
    ...
    <>
      ...
      <div className='container'>
        <main className='relative'>
          ...
          <div
            className={`sticky top-0 inset-x-0 p-4 z-10 ${
          ...
          >
            <div className='sticky top-0'>
              <div className='flex justify-between items-center '>
                <div
                  className='flex gap-2 justify-start items-center bg-opacity-1'
                  onClick={() => router.push('/')}
                >
                  <NextImage
                    alt='Logo'
                ...
                <div
                  className={`h-16 w-16 rounded-lg flex justify-center items-center ${
                    moved ? 'bg-black' : ''
                  } cursor-pointer`}
          ...
          <div className='flex flex-col md:flex-row bg-[#f5f5f5] min-h-[100vh]'>
            <aside
              className='relative font-sm justify-stretch w-full md:w-1/3 '
                      ...
                      >
                        <div className='relative inline-flex break-words'>
                          <div
                            ...
                            style={{
                              backgroundImage: `url("${mentorData?.image_data?.uri}")`,
                              width: '200px',
                              height: '200px',
                              borderRadius: '50%',
                            }}
                        ...
                        <div className='flex flex-row flex-wrap gap-4 mt-4'>
                          {mentorData?.tags?.map((tag, index) => {
                            return (
                              <div
                                key={index}
                                className='rounded-[24px] font-bold text-xs md:text-sm h-8 px-2 inline-flex items-center justify-center border bg-[#f3f3f7]'
                              >
                                {tag}
                              </div>
                            );
            ...
            <div
              className='pt-8 pb-16 min-h-[100vh] flex flex-1 flex-column w-full md:w-2/3 '
                  ...
                  <div className='my-10 flex flex-col flex-wrap w-full'>
                    ...
                    <div className='flex row-wrap'>
                      <div className='pr-1 md:pr-3 w-1/3 lg:w-1/2'>
                        <div
                          className='mt-4 border border-[#ebeaeb] rounded-[32px] h-[176px] flex justify-center items-center bg-[#fdfbf9]'
                          style={{
                            boxShadow:
                              '.5px .5px 4px rgba(0, 0, 0, .03), -.5px -.5px 4px rgba(0, 0, 0, .03)',
                          }}
                        >
                          <NextImage
                            alt='reviews animation'
                            src='/images/reviews_animation.gif'
                            classNames={{
                              image: 'rounded-[50%] aspect-square',
                            }}
                            width={160}
                            height={160}
                          />
                      ...
                      <div className='px-1 md:px-3 w-1/3 lg:w-1/4'>
                        <div
                          className='mt-4 border border-[#ebeaeb] rounded-[32px] h-[176px] flex flex-col justify-center items-center bg-[#fdfbf9] gap-3'
                          style={{
                            boxShadow:
                              '.5px .5px 4px rgba(0, 0, 0, .03), -.5px -.5px 4px rgba(0, 0, 0, .03)',
                          }}
                        >
                          <div className='text-xl lg:text-3xl tracking-wider font-bold'>
                            5/5
                          </div>
                          <div className='text-sm lg:text-md font-normal tracking-wide text-[#666b60] uppercase'>
                            1 rating
                          </div>
                        </div>
                      </div>
                    ...
                    <div className='text-2xl font-bold'>
                      <div className='flex flex-col items-start justify-start'>
                        ...
                        <div className='flex gap-4 items-center flex-wrap mt-4'>
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.linkedin)
                                window.open(
                                ...
                                toast(
                                  '🚧  Whoops! This URL isn’t available right now.',
                                  {
                          ...
                          >
                            <div
                              className='block rounded-[16px] p-5 box-border w-20 h-20 bg-[hsla(0,0%,100%,.95)] rounded-md'
                              style={{
                                boxShadow:
                                  '.5px .5px 4px rgba(0,0,0,.03),-.5px -.5px 4px rgba(0,0,0,.03)',
                              }}
                          ...
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.twitter)
                                window.open(
                          ...
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.youtube)
                                window.open(
                                  mentorData?.socialLinks?.youtube,
                                  '_blank'
                                );
                              else
                                toast(
                          ...
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.instagram)
                                window.open(
                          ...
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.nostr)
                                window.open(
                                  mentorData?.socialLinks?.nostr,
                                  '_blank'
                                );
                              else
                                toast(
                          ...
                          <div
                            onClick={() => {
                              if (mentorData?.socialLinks?.watsapp)
                                window.open(
                                  mentorData?.socialLinks?.watsapp,
                                  '_blank'
                                );
                              else
                                toast(
          ...
          {sidebarOpen && (
            <div
              style={{ backgroundImage: `url("/images/noise-bg.png")` }}
                ...
                <div className='absolute inset-y-0 right-0 max-w-[465px] w-full min-h-screen bg-jet overflow-auto'>
                  <div className='flex-1 flex-col'>
                    <div className='border-b border-b-bone border-opacity-20'>
                      <div
                        className='flex justify-end px-8 py-6 text-bone hover:text-pumpkin cursor-pointer'
                        onClick={toggleSidebar}
                      >
                    ...
                    <div className='flex flex-col flex-1 self-stretch'>
                          ...
                          {SIDEBAR_DATA?.map((item, index) => {
                            return (
                              <Link
                                key={index}
                                href={item?.uri}
                                className='group flex justify-start items-center gap-3 py-3 px-4 border border-transparent hover:border-pumpkin rounded-md'
                                onClick={toggleSidebar}
                              >
                                {item?.image_data?.uri}
                                <div className='text-4xl text-bone font-semibold group-hover:text-pumpkin'>
                                  {item?.title}
                                </div>
                              </Link>
                            );
                      ...
                      <div className='px-14 py-6'>
                        <div className='text-bone font-xs font-light'>
